...
///
/// SIDs are published departure procedures that provide obstacle clearance
/// and traffic flow management from the runway to the enroute structure.
public struct SID: Sendable, Codable, ProcedureLinkable {
  ...
  /// SID identifier (e.g., "RNAV1", "WLSON7").
  public let identifier: String

  /// Route type.
  public let routeType: SIDRouteType
  ...
  /// Whether this is an RNAV SID.
  public var isRNAV: Bool {
    switch routeType {
      case .rnavRunwayTransition, .rnavCommonRoute, .rnavEnrouteTransition:
        true
      default:
        false
    }
...
extension SID: Identifiable, Equatable, Hashable {
  ...
  public static func == (lhs: SID, rhs: SID) -> Bool {
    lhs.id == rhs.id
  }
...
extension SID: CustomStringConvertible {
