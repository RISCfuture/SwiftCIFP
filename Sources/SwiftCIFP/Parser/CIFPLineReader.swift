...
/// Synchronous line reader for CIFP data already in memory.
/// Iterates over lines without creating intermediate String or array of all lines.
struct CIFPLineReader: Sequence, IteratorProtocol, Sendable {
  /// Pre-allocated capacity for line buffer (CIFP lines are 132 bytes).
...
// MARK: - AsyncCIFPLineReader

/// Async line reader for streaming CIFP data from a file URL.
/// Reads in chunks to minimize memory usage for large files.
struct AsyncCIFPLineReader: AsyncSequence, Sendable {
